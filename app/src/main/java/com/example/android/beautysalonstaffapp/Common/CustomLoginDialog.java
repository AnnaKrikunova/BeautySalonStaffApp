...
public class CustomLoginDialog {
    ...
    public void showLoginDialog(String title,
        ...
        btn_login.setOnClickListener(view -> iDialogClickListener.onClickPositiveButton(dialog,
                edt_user.getText().toString(),
                edt_password.getText().toString()));

        btn_cancel.setOnClickListener(view -> iDialogClickListener.onClickNegativeButton(dialog));

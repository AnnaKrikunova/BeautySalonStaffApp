...
import com.example.android.beautysalonstaffapp.Adapter.MyNotificationAdapter;
import com.example.android.beautysalonstaffapp.Common.Common;
import com.example.android.beautysalonstaffapp.Interface.INotificationLoadListener;
    ...
    private void loadNotification(DocumentSnapshot lastDoc) {
        ...
        if (lastDoc == null) {
            notificationCollection.orderBy("serverTimestamp", Query.Direction.DESCENDING)
                        ...
                        .get()
                        .addOnFailureListener(e -> iNotificationLoadListener.onNotificationLoadFailed(e.getMessage())).addOnCompleteListener(task -> {
